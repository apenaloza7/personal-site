document.addEventListener('DOMContentLoaded', () => {
	...
	/**
	 * Gets the rich text renderer from various global export shapes
	 * @function getRichTextRenderer
	 * @returns {Function|null} The rich text renderer function or null if not found
	 */
	function getRichTextRenderer() {
	 ...
	 * @param {Object} node - The rich text node to render
	 * @returns {DocumentFragment|Element} The rendered DOM element
	 */
	...
	/**
	 * Renders rich text document to a container element
	 * @function renderRichTextToContainer
	 * @param {Object} richTextDocument - The rich text document to render
	 * @param {Element} container - The container element to append to
	 */
	...
	/**
	 * Fetches and renders a blog post based on URL parameter
	 * @async
